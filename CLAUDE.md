# 2026claude — 我的班級工具總專案

## 對話開始時請先讀
進度與最近更動都在 Obsidian：`Secondbrain/2026claude/工作筆記.md`
...
## 工作桌 + 三個家
- 📋 GDrive 工作桌：`我的雲端硬碟/2026claude/`（自動跨電腦同步）
- 🐙 GitHub repo：`DerekYang1980TW/2026claude`（公開，網頁的家）
- 📘 Obsidian 駕駛艙：`Secondbrain/2026claude/工作筆記.md`（想法的家）
